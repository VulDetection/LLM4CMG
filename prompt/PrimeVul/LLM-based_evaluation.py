...
df_pred = pd.read_excel('primevul_{}_{}.xlsx'.format(model, prompt))

col = 'primevul_{}_{}'.format(model, prompt)

# 创建或加载 evaluation_llm.xlsx

output_file = 'primevul_evaluation_llm.xlsx'
...
for i in range(len(df_test)):
    ...
    patch = df_test.loc[i, 'search_commit_msg']
